...
\begin{longtable}{|>{\centering\arraybackslash}p{0.8cm}|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}p{4.4cm}|}
...
\vspace{0.3cm}
\noindent\hangindent=1.5cm
{[40]} Y. Wang, X. Liu, and J. Zhang, ``Time Series Data Augmentation for Energy Consumption Data Based on Improved TimeGAN,'' \textit{Sensors}, vol. 25, no. 2, 2025, doi: 10.3390/s25020493.
