...
\section{Metrik Evaluasi Prediksi (sMAPE dan MASE)}
...
\begin{enumerate}
    ...
    MASE mengukur kesalahan absolut model prediksi relatif terhadap kesalahan absolut rata-rata dari model prediksi naif sederhana (\textit{one-step naive forecast}) secara \textit{in-sample} pada data latih. Nilai MASE kurang dari 1 menunjukkan bahwa model memiliki kinerja prediksi yang lebih baik dibandingkan metode naif. Formula MASE didefinisikan sebagai berikut:
    \begin{equation}
