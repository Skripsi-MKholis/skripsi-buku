...
\multirow{10}{*}{2} & \multirow{10}{2.8cm}{Perangkat Lunak (\textit{Software})} & Windows 11 & Sistem Operasi Laptop (Home Single Language). \\ \cline{3-4}
...
& & Firebase & Layanan Google untuk \textit{push notification} (FCM) dan telemetri (Analytics). \\ \cline{3-4}
& & Jupyter Notebook & Lingkungan \textit{pipeline} riset untuk eksplorasi data dan pelatihan model peramalan. \\ \cline{3-4}
& & Hugging Face & Platform \textit{hosting} tempat layanan API prediksi Flask di-\textit{deploy}. \\ \cline{3-4}
...
\noindent\textbf{Lampiran 1. Bimbingan Skripsi (Pembimbing I)}
...
\noindent\textbf{Lampiran 2. Bimbingan Skripsi (Pembimbing II)}
