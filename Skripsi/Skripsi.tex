...
Oleh karena itu, penelitian ini hadir untuk mengisi celah tersebut dengan mengusulkan sistem yang menggabungkan ketiga aspek sekaligus, yaitu: (1) aplikasi POS \textit{mobile} berbasis Flutter dengan kemampuan operasional \textit{offline-first} menggunakan Isar DB dan sinkronisasi otomatis ke Supabase [9],[8]; (2) modul prediksi penjualan harian berbasis LSTM yang dilatih dari data transaksi riil platform EatsTEDI DTEDI Universitas Gadjah Mada [4],[6],[5]; dan (3) penyajian hasil prediksi secara langsung kepada pengguna melalui dasbor analitik di dalam aplikasi yang sama [12].

\section{Sistem \textit{Point of Sale} (POS)}

Sistem \textit{Point of Sale} (POS) merupakan kombinasi perangkat keras dan perangkat lunak yang digunakan untuk memproses transaksi penjualan pada titik pembelian. Dalam konteks UMKM, sistem POS berfungsi sebagai alat pencatatan transaksi, pengelolaan stok barang, dan pelaporan keuangan yang menggantikan proses manual berbasis buku catatan. Perkembangan teknologi \textit{mobile} telah mendorong lahirnya aplikasi POS berbasis Android yang lebih fleksibel, murah, dan mudah dioperasikan oleh pelaku usaha kecil tanpa keahlian teknis khusus [2],[1].
...
%%=============================================================
%% LAMPIRAN - FORM BIMBINGAN SKRIPSI
%%=============================================================
\newpage
\thispagestyle{empty}
\begin{spacing}{1.0}

\noindent\textbf{Lampiran. Bimbingan Skripsi (Pembimbing I)}

\begin{center}
{\large\bfseries FORM BIMBINGAN SKRIPSI}
\end{center}
\vspace{0.3cm}
...
NIM MAHASISWA & : 2022573010098 \\
JUDUL SKRIPSI & : Rancang Bangun Aplikasi \textit{Point of Sale} dengan Fitur Prediksi \\
 & \ \ Penjualan Harian Menggunakan Metode \textit{Long Short-Term} \\
 & \ \ \textit{Memory} (LSTM) \\
DOSEN PEMBIMBING I & : Zulfan Khairil Simbolon, S.T., M.Eng. \\
\end{tabular}

\vspace{0.4cm}

\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}p{0.7cm}|>{\centering\arraybackslash}p{2.6cm}|X|>{\centering\arraybackslash}p{2.8cm}|}
\hline
\textbf{No} & \textbf{Hari/ Tanggal Bimbingan} & \textbf{Materi Bimbingan} & \textbf{Tanda Tangan Pembimbing} \\
\hline
1 & & & \\
\hline
2 & & & \\
...
\begin{flushright}
\begin{tabular}{@{}l@{}}
Lhokseumawe, \dotfill \\[0.8cm]
Ketua Program Studi \\
Teknik Informatika \\[2cm]
\textbf{\underline{M. Khadafi, S.T., M.T}} \\
...
\noindent\textbf{Lampiran. Bimbingan Skripsi (Pembimbing II)}
...
JUDUL SKRIPSI & : Rancang Bangun Aplikasi \textit{Point of Sale} dengan Fitur Prediksi \\
 & \ \ Penjualan Harian Menggunakan Metode \textit{Long Short-Term} \\
 & \ \ \textit{Memory} (LSTM) \\
DOSEN PEMBIMBING II & : Azhar, S.T., M.T. \\
\end{tabular}
