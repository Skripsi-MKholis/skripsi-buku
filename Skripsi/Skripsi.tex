...
\begin{enumerate}
    ...
    \item Metode penyaji prediksi pada layanan produksi ditentukan berdasarkan hasil evaluasi komparatif, sehingga dapat berbeda dari metode yang menjadi objek kajian utama.
\end{enumerate}
