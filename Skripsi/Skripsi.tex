...
\textit{Activity Diagram} merupakan gambaran visual yang digunakan untuk menggambarkan serangkaian aktivitas atau proses yang terjadi di dalam sistem. Diagram ini memudahkan penjelasan mengenai logika prosedural, alur kerja, serta titik percabangan keputusan pada aplikasi \textit{Point of Sale} yang dilengkapi fitur prediksi penjualan harian. Pada penelitian ini, pemodelan \textit{activity diagram} difokuskan pada empat alur kerja yang paling representatif terhadap karakteristik sistem, yaitu pengelolaan katalog produk sebagai sumber data penjualan, transaksi kasir sebagai penghasil data utama, penyajian prediksi penjualan harian sebagai inti penelitian, serta sinkronisasi data sebagai penopang keandalan pencatatan. Adapun rincian masing-masing \textit{activity diagram} diuraikan sebagai berikut.

\noindent 1)~~\textit{Activity Diagram} Mengelola Katalog Produk

Pengelolaan katalog produk digunakan untuk memelihara data produk dan persediaan yang menjadi sumber masukan bagi pencatatan transaksi penjualan. \textit{Activity diagram} staf toko dalam mengelola katalog produk dapat dilihat pada Gambar~\ref{fig:act-produk}.
