...
Bab ini berisi kajian literatur dan landasan teori yang relevan dengan penelitian. Kajian mencakup perbandingan metode prediksi penjualan dan implementasi sistem POS berbasis \textit{mobile}. Landasan teori menyajikan konsep prediksi, arsitektur LSTM, \textit{framework} Flutter, bahasa Dart, serta layanan Supabase yang digunakan sebagai infrastruktur sistem.
